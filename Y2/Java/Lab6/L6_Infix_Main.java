...
import Lab5.pack5_StackQueue.code.MyRPN_651558;
import Lab6.code.MyQueueL_651558;
import Lab6.code.MyShuntingYard_65011558;
...
public class L6_Infix_Main {
    ...
    public static void computeInfix(String infixString) {
        String postfixString = MyShuntingYard_65011558.infixToPostfix(infixString);
        double ans = MyRPN_651558.computeRPN(postfixString);
