...
import Lab3.pack3_ArrayLinkedList.code.MyLinkedList_651558;
...
public class L4_LinkedList_Main {
    ...
    static void demo1() {
        MyLinkedList_651558 list = new MyLinkedList_651558();
        list.add(5);
        list.add(1);
        list.insert(4);
        list.insert(3);
    ...
    static void demo2() {
        MyLinkedList_651558 mList = new MyLinkedList_651558();
        mList.insert(50);
        mList.insert(40);
        mList.insert(30);
        mList.insert(20);
